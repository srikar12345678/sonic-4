...
function preload(){
  ...
  obstacleImg=loadImage("bomb3.png");
...
ground.x=ground.width/2;
  ...
  if(sonic.isTouching(coinGroup)){
    ...
    if(sonic.isTouching(obstaclesGroup)){
     ...
     if(sonic.isTouching(obstacles2Group)){
      gameState = "end";
     }
...
if(frameCount % 200 === 0){
            var obstacle2 = createSprite(400,435,10,10);
            obstacle2.addImage("obstacle2",obstacleImg);
           obstacle2.scale = 0.5;
           obstacle2.velocityX = -(4+score/100);
